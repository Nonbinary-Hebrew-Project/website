...
export default function TransliteratePage() {
  ...
  return (
    ...
    >
      ...
      <textarea style={{width:"50%", resize:"vertical"}} rows={4} onChange={(e) => setValue(e.target.value)}></textarea>
      {value ? <HebrewBlock>{value}</HebrewBlock> : <p>Type or paste hebrew in the box above and it will be transliterated here.</p>}
      </div>
    </Layout>
  );
}
